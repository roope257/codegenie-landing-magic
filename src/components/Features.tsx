...
const FeatureCard = ({
  ...
  title,
  description
}: Feature) => <div className="glass-card p-6 rounded-xl card-hover">
...
const Features = () => {
  ...
  return <SectionContainer id="features" className="bg-gradient-to-br from-green-50 to-emerald-50 relative overflow-hidden">
